...
import com.sharkz.largeimage.sdk.task.TaskQueue;
...
import static com.sharkz.largeimage.sdk.ToolKit.dip2px;
...
public class BlockImageLoader {
     ...
     * 设置图片加载监听器
     *
     * @param onImageLoadListener listener
     */
     ...
     * 设置 图片加载状态监听器
     *
     * @param onLoadStateChangeListener listener
     */
...
//        if(blockData1.size()>0)
    ...
    private boolean isUnRunning(Task task) {
        return task == null;
    }
